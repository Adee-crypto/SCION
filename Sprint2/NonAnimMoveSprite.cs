...
class NonAnimMoveSprite(Texture2D spriteSheet, Rectangle data, Vector2 position) : ISprite {
    ...
    {
        pos.X = (float) Math.Cos(gameTime.TotalGameTime.TotalSeconds*2) * 100 + 200;
