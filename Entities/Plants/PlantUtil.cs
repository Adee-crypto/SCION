...
{
    public static readonly Species[] species = [Species.Apple, Species.Grass, Species.Pineapple, Species.Sandbox, Species.Cherry, Species.Gravebind, Species.Catalyst];
